...
(*MARK_DEBUG="TRUE"*) wire ram_we;
(*MARK_DEBUG="TRUE"*) wire[31:0] ram_addr;
(*MARK_DEBUG="TRUE"*) wire[31:0] ram_data_o; // from the view of openmips
(*MARK_DEBUG="TRUE"*) wire[31:0] ram_data_i; // from the view of openmips
(*MARK_DEBUG="TRUE"*) wire[3:0] ram_sel;
wire ram_ce;
wire[31:0] right_count;
wire[5:0] int;
wire timer_int;
wire enable_mmu;
(*MARK_DEBUG="TRUE"*) wire pause_signal;
...
mmu_memory mmu_memory_version1 (
    ...
    .data_input_data(ram_data_o), // 需要写入的数据
    .data_output_data(ram_data_i), // 返回给cpu的数据
