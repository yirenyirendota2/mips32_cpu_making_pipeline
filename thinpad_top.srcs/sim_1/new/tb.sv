...
parameter BASE_RAM_INIT_FILE = "C:/Users/liujiashuo/Desktop/function_test/kernel.bin"; //BaseRAM初始化文件，请修改为实际的绝对路径
parameter EXT_RAM_INIT_FILE = "C:/Users/liujiashuo/Desktop/function_test/kernel.bin";    //ExtRAM初始化文件，请修改为实际的绝对路径
